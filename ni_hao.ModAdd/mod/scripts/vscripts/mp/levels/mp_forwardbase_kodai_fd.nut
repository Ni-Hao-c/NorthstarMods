...
void function initFrontierDefenseData()
{
    ...
    array<vector> originss=[]
    originss.append(< 1720.05, 4879.63, 936.42 >)
    originss.append(< 1214.48, 4267.87, 968.429 >)
    originss.append(< 1992.91, 3963.89, 920.9 >)
    originss.append(< 3463.04, 2016.4, 944.309 >)
    originss.append(< 4525.32, 1267.45, 944.309 >)
    originss.append(< 3578.41, 398.068, 944.309 >)
    originss.append(< 1534.14, -1321.07, 808.098 >)
    originss.append(< 2567.61, -1991.76, 795.688 >)
    originss.append(< 2245.78, -3388.93, 795.666 >)

	array<vector> hz = []
hz.append(< 1373.469971, 1219.410034, 1314.339966 >)
hz.append(< 2665.060059, 4456.129883, 960.687988>)
hz.append(< 2475.810059, -3544.189941, 810.218994>)
hz.append(< 3144.659912, 2935.629883, 917.218994>)




    //wave5.append(RandomtitanTypes[ RandomInt(6) ](originss,< -0, 0, 0>,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    ...
    //     wave1.append(CreateRandomNukeNIUTitanEvent(originss,< -0, 0, 0>,"",index++))
     //  wave1.append( CreateSpawnShipEvent( < 864.625000, 693.750000, 2379.910034 >, < 0,0,0 >, "hillRouteClose", index++ ) )
    //     wave1.append( CreateRandomMortarNIUTitanEvent(originss,< -0, 0, 0>,index++))
    //  wave1.append( CreateWaitForTimeEvent(50.2, index++ ) )    
     //===================================================//
    ...
    //wave1.append( CreateRandomShotNIUTitanEvent(hz,< 0.004999, 90.003700, 0.000004 >,"",index++))
    ...
    wave1.append( CreateSpawndronebeamEvent( < 2427.310059, -2561.379883, 1379 >, < 0.004999, 90.003700, 0.000004 >, "", index++, false ) )
    wave1.append( CreateWaitUntilAliveWeightedEvent( 1, index++ ) )
    wave1.append( CreateWaitForTimeEvent(5 , index++ ) )
    wave1.append( CreateSpawndroneShieldEvent( < 2427.310059, -2561.379883, 1379>, < 0.004999, 90.003700, 0.000004 >, "", index++, false ) )
    wave1.append( CreateWaitUntilAliveWeightedEvent( 1, index++ ) )
    wave1.append( CreateSpawndroneEMPEvent( < 2427.310059, -2561.379883, 1379 >, < 0.004999, 90.003700, 0.000004 >, "", index++, false ) )
    wave1.append( CreateWaitUntilAliveWeightedEvent( 1, index++ ) )
    ...
    wave1.append( CreateWaitForTimeEvent( 1.3829956, index++ ) )
    wave1.append( CreateDroppodGruntEvent( < 1258.060059, 921.593994, 1330.750000 >, "hillRouteClose", index++ ) )
    wave1.append( CreateNorthstarSniperTitanEvent( < 1373.469971, 1219.410034, 1314.339966 >, < 0.000000, 169.541000, 0.000000 >,index++ ) )
    wave1.append( CreateWaitForTimeEvent( 1.5, index++ ) )
    wave1.append( CreateDroppodGruntEvent( < 1116.630005, 329.750000, 1372.280029 >, "hillRouteClose", index++ ) )
    wave1.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave1.append( CreateWaitUntilAliveWeightedEvent( 8, index++ ) )
    ...
    wave1.append( CreateDroppodGruntEvent( < 884.625000, 1721.750000, 1377.410034 >, "hillRouteClose", index++ ) )
    wave1.append( CreateWaitForTimeEvent( 0.6159973, index++ ) )
    //wave1.append( CreateLegionTitanEvent( < 1762.839966, -1604.750000, 812.281006 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    ...
    wave2.append( CreateRandomSmartNIUTitanEvent(hz,< 0.004999, 90.003700, 0.000004 >,"",index++))
    ...
    wave2.append( CreateScorchTitanEvent( < 2475.810059, -3544.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave2.append( CreateWaitForTimeEvent( 1.3000183, index++ ) )
    wave2.append( CreateScorchTitanEvent( < 2665.060059, 4456.129883, 960.687988 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    ...
    wave2.append( CreateDroppodSpectreEvent( < 1258.060059, 921.593994, 1330.750000 >, "", index++ ) )
    wave2.append( CreateRandomSmartNIUTitanEvent(hz,< 0.000000, -141.108002, 0.000000 >,"",index++))
    wave2.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave2.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave2.append( CreateDroppodSpectreEvent( < 864.625000, 693.750000, 1379.910034 >, "", index++ ) )
    ...
    wave2.append( CreateDroppodTickEvent( < 3248.840088, 161.156006, 951.781006 >, 4, "hillRouteClose", index++ ) )
    wave2.append( CreateRandomSmartNIUTitanEvent(hz,< 0.000000, -141.108002, 0.000000 >,"",index++))
    wave2.append( CreateRandomSmartNIUTitanEvent(hz,< 0.000000, 90.000000, 0.000000 >,"",index++))
    wave2.append( CreateDroppodTickEvent( < 864.625000, 693.750000, 1379.910034 >, 4, "hillRouteClose", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 0.1, index++ ) )
    wave2.append( CreateSmokeEvent( < -12, 1720, 1540 >, 120, index++ ) )
    wave2.append( CreateWaitForTimeEvent( 0.2, index++ ) )
    ...
    wave2.append( CreateWaitForTimeEvent( 1.6999817, index++ ) )
    wave2.append( CreateDroppodGruntEvent( < 864.625000, 693.750000, 1379.910034 >, "", index++ ) )
    wave2.append( CreateIonTitanEvent( < 1817.380005, -3585.909912, 813.937988 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE) )
    ...
    wave2.append( CreateIonTitanEvent( < 2614.879883, 4771.560059, 951.000000 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave2.append( CreateWaitForTimeEvent( 2.9160156, index++ ) )
    wave2.append( CreateDroppodSpectreEvent( < 1258.060059, 921.593994, 1330.750000 >, "", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave2.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    ...
    wave2.append( CreateDroppodSpectreEvent( < 3156.560059, 2266.939941, 951.781006 >, "", index++ ) )
    wave2.append( CreateNukeTitanEvent( < 3144.659912, 2935.629883, 917.218994 >, < 0.000000, 179.341003, 0.000000 >, "", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 1.2000122, index++ ) )
    wave2.append( CreateNukeTitanEvent( < 3739.129883, 1985.719971, 947.281006 >, < 0.000000, 180.000000, 0.000000 >, "", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 1.1999817, index++ ) )
    wave2.append( CreateDroppodSpectreEvent( < 2336.000000, 1968.000000, 953.531006 >, "", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave2.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    ...
    wave2.append( CreateNukeTitanEvent( < 3739.129883, 1985.719971, 947.281006 >, < 0.000000, 180.000000, 0.000000 >, "", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 0.5999756, index++ ) )
    wave2.append( CreateNukeTitanEvent( < -31.906300, 4688.660156, 1027.660034 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave2.append( CreateWaitForTimeEvent( 1.2659912, index++ ) )
    wave2.append( CreateNukeTitanEvent( < 1293.939941, 1827.410034, 1321.750000 >, < 0.000000, 169.541000, 0.000000 >, "", index++ ) )
    ...
    wave2.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave2.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave2.append( CreateScorchTitanEvent( < 2821.659912, -2937.090088, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE) )
    wave2.append( CreateWaitForTimeEvent( 1.0, index++ ) )
    wave2.append( CreateScorchTitanEvent( < 3123.560059, 4202.060059, 954.343994 >, < 0.000000, -141.108002, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE) )
    wave2.append( CreateWaitForTimeEvent( 0.1159668, index++ ) )
    ...
    wave3.append( CreateIonTitanEvent( < 1762.839966, -1604.750000, 812.281006 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave3.append( CreateToneTitanEvent( < 1761.839966, -1603.750000, 812.281006 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave3.append( CreateLegionTitanEvent( < 1762.839966, -1604.750000, 812.281006 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave3.append( CreateScorchTitanEvent( < 1762.839966, -1603.750000, 812.281006 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave3.append( CreateMonarchTitanEvent( < 1764.839966, -1601.750000, 807.281006 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    ...
    wave3.append( CreateDroppodSpectreEvent( < 1045.339966, -2843.340088, 804.812988 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 3.4000244, index++ ) )
    wave3.append( CreateDroppodSpectreEvent( < 346.312988, -2838.659912, 803.968994 >, "", index++ ) )
    ...
    wave3.append( CreateScorchTitanEvent( < 2665.340088, 4456.500000, 960.656006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave3.append( CreateWaitForTimeEvent( 0.8829956, index++ ) )
    wave3.append( CreateToneTitanEvent( < 3123.250000, 4201.689941, 954.281006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 0.6000366, index++ ) )
    wave3.append( CreateToneTitanEvent( < 1324.160034, 4820.189941, 937.531006 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave3.append( CreateWaitForTimeEvent( 1.0, index++ ) )
    wave3.append( CreateNukeTitanEvent( < 3144.659912, 2935.629883, 917.218994 >, < 0.000000, 179.341003, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.2000122, index++ ) )
    wave3.append( CreateNukeTitanEvent( < 3739.129883, 1985.719971, 947.281006 >, < 0.000000, 180.000000, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.5, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 1087.839966, 3863.840088, 931.750000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.3499756, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 908.750000, 3093.629883, 967.500000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.2999878, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 3156.560059, 2266.939941, 951.781006 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave3.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 1935.839966, 3727.840088, 931.656006 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 0.7000122, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 2111.840088, 3295.840088, 939.031006 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 0.9830322, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 1087.839966, 3863.840088, 931.750000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 3.5999756, index++ ) )
    wave3.append( CreateWarningEvent( FD_IncomingWarnings.MortarTitanIntro, index++ ) )
    wave3.append( CreateMortarTitanEvent( < 2475.810059, -3544.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >, index++ ) )
    wave3.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave3.append( CreateMortarTitanEvent( < 2821.340088, -2935.719971, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, index++ ) )
    wave3.append( CreateMortarTitanEvent( < 2471.810059, -3544.189941, 815.218994 >, < 0.000000, 93.000000, 0.000000 >, index++ ) )
    wave3.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave3.append( CreateMortarTitanEvent( < 2825.340088, -2932.719971, 824.937988 >, < 0.000000, 127.202003, 0.000000 >, index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.3499756, index++ ) )
    wave3.append( CreateScorchTitanEvent( < 2665.340088, 4456.500000, 960.656006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave3.append( CreateWaitForTimeEvent( 1.0670166, index++ ) )
    wave3.append( CreateScorchTitanEvent( < 3123.560059, 4202.060059, 954.343994 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.21698, index++ ) )
    wave3.append( CreateIonTitanEvent( < 1324.160034, 4820.189941, 937.531006 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave3.append( CreateWaitForTimeEvent( 0.9160156, index++ ) )
    wave3.append( CreateIonTitanEvent( < 3144.159912, 2935.530029, 917.187988 >, < 0.000000, 179.341003, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave3.append( CreateWaitForTimeEvent( 0.684021, index++ ) )
    wave3.append( CreateNukeTitanEvent( < 3739.129883, 1985.719971, 947.281006 >, < 0.000000, 180.000000, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 0.5999756, index++ ) )
    wave3.append( CreateNukeTitanEvent( < -31.906300, 4688.660156, 1027.660034 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.2659912, index++ ) )
    wave3.append( CreateNukeTitanEvent( < 1293.939941, 1827.410034, 1321.750000 >, < 0.000000, 169.541000, 0.000000 >, "", index++ ) )
    wave3.append( CreateWaitForTimeEvent( 1.5339966, index++ ) )
    wave3.append( CreateDroppodStalkerEvent( < 908.750000, 3093.629883, 967.500000 >, "", index++ ) )
    ...
    wave3.append( CreateDroppodSpectreEvent( < 1418.310059, -2254.659912, 810.031006 >, "", index++ ) )
    ...
    wave3.append( CreateDroppodSpectreEvent( < 2457.310059, -2563.659912, 789.250000 >, "", index++ ) )
    ...
    wave4.append( CreateDroppodStalkerEvent( < 2111.840088, 3295.840088, 939.031006 >, "", index++ ) )
    wave4.append( CreateDroppodTickEvent( < 864.625000, 693.750000, 1379.910034 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.1, index++ ) )
    wave4.append( CreateSmokeEvent( < -12, 1720, 1540 >, 120, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.2, index++ ) )
    wave4.append( CreateSmokeEvent( < -64, 964, 1540 >, 120, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.7169983, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 884.625000, 1721.750000, 1377.410034 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.6500244, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 1226.410034, 1391.130005, 1334.689941 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.0329895, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 1258.060059, 921.593994, 1330.750000 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave4.append( CreateWaitUntilAliveWeightedEvent( 12, index++ ) )
    wave4.append( CreateToneSniperTitanEvent( < 1373.469971, 1219.410034, 1314.339966 >, < 0.000000, 169.541000, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.0159912, index++ ) )
    wave4.append( CreateToneSniperTitanEvent( < 1209.469971, 579.406006, 1332.310059 >, < 0.000000, 169.541000, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.8999939, index++ ) )
    wave4.append(CreateWarningEvent( FD_IncomingWarnings.EnemyTitansIncoming, index++ ))
    wave4.append( CreateToneTitanEvent( < 2475.810059, -3544.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave4.append( CreateWaitForTimeEvent( 1.3000183, index++ ) )
    wave4.append( CreateToneTitanEvent( < 2665.060059, 4456.129883, 960.687988 >, < 0.000000, -141.108002, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave4.append( CreateWaitForTimeEvent( 1.1499939, index++ ) )
    wave4.append( CreateDroppodSpectreMortarEvent( < 864.625000, 693.750000, 1379.910034 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave4.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave4.append( CreateDroppodSpectreMortarEvent( < 884.625000, 1721.750000, 1377.410034 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.6000061, index++ ) )
    wave4.append( CreateDroppodGruntEvent( < 1226.410034, 1391.130005, 1334.689941 >, "", index++ ) )
    ...
    wave4.append( CreateWaitForTimeEvent( 0.7169983, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 884.625000, 1721.750000, 1377.410034 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateNukeTitanEvent( < 2475.909912, -3544.659912, 810.281006 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    ...
    wave4.append( CreateNukeTitanEvent( < 2821.659912, -2937.090088, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ) )
    ...
    wave4.append( CreateNukeTitanEvent( < 1817.469971, -3586.379883, 814.062988 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    ...
    wave4.append( CreateNukeTitanEvent( < 2474.909912, -3544.659912, 810.281006 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.2000732, index++ ) )
    wave4.append( CreateNukeTitanEvent( < 2665.340088, 4456.500000, 960.656006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.2999268, index++ ) )
    wave4.append( CreateNukeTitanEvent( < 2823.659912, -2937.090088, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.8000488, index++ ) )
    wave4.append( CreateNukeTitanEvent( < 3121.560059, 4202.060059, 954.343994 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave4.append( CreateNukeTitanEvent( < 1816.469971, -3586.379883, 814.062988 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.6999512, index++ ) )
    wave4.append( CreateNukeTitanEvent( < 1325.060059, 4820.660156, 937.562988 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.6500244, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 1226.410034, 1391.130005, 1334.689941 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.0329895, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 1258.060059, 921.593994, 1330.750000 >, 4, "hillRouteClose", index++ ) )
    ...
    wave4.append( CreateWaitForTimeEvent( 1.0329895, index++ ) )
    wave4.append( CreateDroppodTickEvent( < 1258.060059, 921.593994, 1330.750000 >, 4, "hillRouteClose", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.6999817, index++ ) )
    wave4.append( CreateDroppodGruntEvent( < 864.625000, 693.750000, 1379.910034 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 2.9160156, index++ ) )
    wave4.append( CreateDroppodSpectreEvent( < 1258.060059, 921.593994, 1330.750000 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave4.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave4.append( CreateDroppodGruntEvent( < 864.625000, 693.750000, 1379.910034 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.8659973, index++ ) )
    wave4.append( CreateDroppodGruntEvent( < 884.625000, 1721.750000, 1377.410034 >, "", index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.6839905, index++ ) )
    wave4.append( CreateDroppodSpectreEvent( < 1226.410034, 1391.130005, 1334.689941 >, "", index++ ) )
    ...
    wave4.append( CreateWaitForTimeEvent( 1.3499756, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2473.810059, -3542.189941, 810.218994 >, < 0.000000, 88.000000, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2826.340088, -2953.719971, 826.937988 >, < 0.000000, 102.202003, 0.000000 >, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2474.810059, -3534.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2822.340088, -2926.719971, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.3499756, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2474.810059, -3542.189941, 810.218994 >, < 0.000000, 88.000000, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2828.340088, -2933.719971, 826.937988 >, < 0.000000, 110.202003, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 1.3499756, index++ ) )
    wave4.append( CreateScorchTitanEvent( < 2665.340088, 4456.500000, 960.656006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave4.append( CreateMortarTitanEvent( < 2475.810059, -3544.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >, index++ ) )
    wave4.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave4.append( CreateMortarTitanEvent( < 2826.340088, -2933.719971, 826.937988 >, < 0.000000, 110.202003, 0.000000 >, index++ ) )
    ...
    wave4.append( CreateScorchTitanEvent( < 1324.060059, 4820.660156, 937.562988 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE) )
    wave4.append( CreateWaitForTimeEvent( 1.2200317, index++ ) )
    wave4.append( CreateScorchTitanEvent( < 3144.659912, 2935.629883, 917.218994 >, < 0.000000, 179.341003, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    ...
    wave4.append( CreateToneSniperTitanEvent( < 4453.129883, 964.750000, 947.281006 >, < 0.000000, -172.529007, 0.000000 >,index++ ,FD_TitanType.TITAN_ELITE))
    wave4.append( CreateWaitForTimeEvent( 1.210083, index++ ) )
    wave4.append( CreateToneSniperTitanEvent( < 3866.659912, 1445.630005, 947.281006 >, < 0.000000, 180.000000, 0.000000 >,index++ ,FD_TitanType.TITAN_ELITE))
    wave4.append( CreateMonarchTitanEvent( < 3866.659912, 1445.630005, 947.281006 >, < 0.000000, 180.000000, 0.000000 >, "", 0 ,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave5.append( CreateWaitForTimeEvent( 0.7169983, index++ ) )
    wave5.append( CreateDroppodTickEvent( < 884.625000, 1721.750000, 1377.410034 >, 4, "hillRouteClose", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.6500244, index++ ) )
    wave5.append( CreateDroppodTickEvent( < 1226.410034, 1391.130005, 1334.689941 >, 4, "hillRouteClose", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0329895, index++ ) )
    wave5.append( CreateDroppodTickEvent( < 1258.060059, 921.593994, 1330.750000 >, 4, "hillRouteClose", index++ ) )
    ...
    wave5.append( CreateWaitForTimeEvent( 1.0329895, index++ ) )
    wave5.append( CreateDroppodTickEvent( < 1258.060059, 921.593994, 1330.750000 >, 4, "hillRouteClose", index++ ) )
    wave5.append( CreateMortarTitanEvent( < 2475.810059, -3544.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave5.append( CreateMortarTitanEvent( < 2821.340088, -2936.719971, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.3499756, index++ ) )
    wave5.append( CreateMortarTitanEvent( < 2473.810059, -3542.189941, 810.218994 >, < 0.000000, 88.000000, 0.000000 >, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.5830078, index++ ) )
    wave5.append( CreateMortarTitanEvent( < 2826.340088, -2933.719971, 826.937988 >, < 0.000000, 110.202003, 0.000000 >, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 10.3, index++ ) )
    ...
    wave5.append( CreateDroppodTickEvent( < 864.625000, 693.750000, 1379.910034 >, 4, "hillRouteClose", index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1372.469971, 1214.410034, 1312.339966 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    ...
    wave5.append( CreateNukeTitanEvent( < 1373.469971, 1219.410034, 1314.339966 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1202.469971, 574.406006, 1324.310059 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    ...
    wave5.append( CreateNukeTitanEvent( < 2474.909912, -3544.659912, 810.281006 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.2000732, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 2665.340088, 4456.500000, 960.656006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.2999268, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 2823.659912, -2937.090088, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.8000488, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1373.469971, 1219.410034, 1314.339966 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1816.469971, -3586.379883, 814.062988 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.6999512, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1209.469971, 579.406006, 1332.310059 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.1, index++ ) )
    ...
    wave5.append( CreateNukeTitanEvent( < 2823.659912, -2937.090088, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.8000488, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 3121.560059, 4202.060059, 954.343994 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1816.469971, -3586.379883, 814.062988 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.6999512, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1325.060059, 4820.660156, 937.562988 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.1, index++ ) )
    wave5.append( CreateSmokeEvent( < -12, 1720, 1540 >, 120, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.2, index++ ) )
    wave5.append( CreateSmokeEvent( < -64, 964, 1540 >, 120, index++ ) )
    ...
    wave5.append( CreateScorchTitanEvent( < 1559.910034, -2024.660034, 803.031006 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    wave5.append( CreateWaitForTimeEvent( 0.8100586, index++ ) )
    wave5.append( CreateScorchTitanEvent( < 2411.909912, -1108.660034, 803.375000 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE ) )
    ...
    wave5.append( CreateNukeTitanEvent( < 2665.340088, 4456.500000, 960.656006 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.2999268, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1209.469971, 579.406006, 1332.310059 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.8000488, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 3121.560059, 4202.060059, 954.343994 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1816.469971, -3586.379883, 814.062988 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.6999512, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1322.060059, 4814.660156, 938.562988 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave5.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave5.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave5.append( CreateToneTitanEvent( < 2475.810059, -3544.189941, 810.218994 >, < 0.000000, 90.000000, 0.000000 >, "", index++))
    ...
    wave5.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave5.append( CreateWaitUntilAliveWeightedEvent( 16, index++ ) )
    wave5.append( CreateToneSniperTitanEvent( < 4466.220215, 1469.410034, 947.281006 >, < 0.000000, 169.541000, 0.000000 >,  index++ ,FD_TitanType.TITAN_ELITE))
    wave5.append( CreateWaitForTimeEvent( 0.9000244, index++ ) )
    wave5.append( CreateToneSniperTitanEvent( < 4453.129883, 964.750000, 947.281006 >, < 0.000000, -172.529007, 0.000000 >, index++ ,FD_TitanType.TITAN_ELITE))
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    ...
    wave5.append( CreateNukeTitanEvent( < 2823.659912, -2937.090088, 827.937988 >, < 0.000000, 117.202003, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.8000488, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1219.469971, 589.406006, 1336.310059 >, < 0.000000, -141.108002, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 1.0999756, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1219.469971, 589.406006, 1332.310059 >, < 0.000000, 90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 0.6999512, index++ ) )
    wave5.append( CreateNukeTitanEvent( < 1209.469971, 579.406006, 1332.310059 >, < 0.000000, -90.000000, 0.000000 >, "", index++ ) )
    wave5.append( CreateWaitForTimeEvent( 5.0, index++ ) )
    wave5.append(RandomtitanTypes[ RandomInt(6) ](originss,< -0, 0, 0>,"",index++,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave5.append( CreateWaitForTimeEvent( 0.6999512, index++ ) )
    wave5.append( CreateIonTitanEvent( < 2411.810059, -1108.189941, 803.375000 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave5.append( CreateScorchTitanEvent( < 4466.220215, 1469.410034, 947.281006 >, < 0.000000, 169.541000, 0.000000 >, "", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    wave5.append( CreateScorchTitanEvent( < 2411.810059, -1108.189941, 803.375000 >, < 0.000000, 90.000000, 0.000000 >,"", index++ ,1,"",FD_TitanType.TITAN_ELITE))
    ...
    wave5.append( CreateWaitForTimeEvent( 1.3000488, index++ ) )
    wave5.append( CreateArcTitanEvent( < 3867.129883, 1445.719971, 947.281006 >, < 0.000000, 180.000000, 0.000000 >, "", 0))
