...
void function OnTitanfall( entity titan )
{
	...
	if( GetTitanName( titan ) == "遠征" )
		tips += "关闭\"帝王边境\"皮肤"
	else if( GetTitanName( titan ) == "神盾軍團帝王" )
		tips += "关闭\"帝王堅韌黑\"皮肤"
	else if( GetTitanName( titan ) == "神盾烈焰帝王" )
		tips += "关闭\"帝王堅韌橘\"皮肤"
	else if( GetTitanName( titan ) == "神盾浪人帝王" )
		tips += "关闭\"帝王堅韌大海\"皮肤"
	else if( GetTitanName( titan ) == "神盾强力帝王" )
		tips += "关闭\"帝王堅韌蕨類\"皮肤"
	else if( GetTitanName( titan ) == "神盾離子帝王" )
		tips += "关闭\"帝王堅韌松針\"皮肤"
	else if( GetTitanName( titan ) == "神盾爆發帝王" )
		tips += "关闭\"帝王堅韌白\"皮肤"
	else if( GetTitanName( titan ) == "神盾北極星帝王" )
		tips += "关闭\"帝王堅韌陰影\"皮肤"
	else if( GetTitanName( titan ) == "神盾野獸帝王" )
		tips += "关闭\"帝王堅韌金\"皮肤"
	else if( GetTitanName( titan ) == "神盾護盾帝王" )
		tips += "关闭\"帝王堅韌紫\"皮肤"
