...
void function Shift_Core_Init()
{
	...
	AddCallback_OnPlayerKilled(SwordCore_OnPlayedOrNPCKilled_VAV)
	AddCallback_OnNPCKilled(SwordCore_OnPlayedOrNPCKilled_VAV)
	#endif
}
...
void function SwordCore_OnPlayedOrNPCKilled_VAV( entity victim, entity attacker, var damageInfo )
{
	if ( !victim.IsTitan() )
		return
