...
const SNIPER_PROJECTILE_SPEEDEX			= 12000
...
function FireSniper( entity weapon, WeaponPrimaryAttackParams attackParams, bool playerFired )
{
	...
	if(weapon.HasMod("exsniper")){
		entity bolt = weapon.FireWeaponBolt( attackParams.pos, attackParams.dir, SNIPER_PROJECTILE_SPEEDEX, DF_GIB | DF_BULLET | DF_ELECTRICAL, DF_EXPLOSION | DF_RAGDOLL, playerFired, 0 )
		if ( bolt )
		{
	...
	else if(!weapon.HasMod("exsniper")){
