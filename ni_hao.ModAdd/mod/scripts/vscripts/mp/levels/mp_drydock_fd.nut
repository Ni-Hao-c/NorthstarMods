...
void function initFrontierDefenseData()
{
	...
	array<vector> hz = [< -1680.21 ,3177.71, 118.764 >]
	array<vector> hy = [< 2430.32 ,3083.17, -79.5225 >]
	array<vector> qz = [< 2430.32 ,3083.17, -79.5225 >]
	array<vector> qy = [< -1764.65, -2245.26, 117 >]
	...
	wave5.append(CreateWaitForTimeEvent(1.6,index++))
	wave5.append( CreateMortarTitanEvent( <  -1794.35, -2298.82, 101.031 > , < 0, 12.2698, 0 >, index++ ) )
	wave5.append(CreateRandomArcNIUTitanEvent(hz,< 0 , -60 , 0 >,"rightSwitchLong1",index++))//14 后右 一圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateRandomArcNIUTitanEvent(hy,< 0 , -60 , 0 >,"rightSwitchLong2",index++))//10 后左 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateScorchTitanEvent(< 2430.32 ,3083.17, -79.5225 >,< 0 , -60 , 0 >,"rightSwitchLong2",index++))//10 后左 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 8, index++ ) )
	wave5.append(CreateRandomArcNIUTitanEvent(qz,< 0 , -60 , 0 >,"leftSwitchLong01",index++))//9 前左 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateScorchTitanEvent(< 2430.32 ,3083.17, -79.5225 >,< 0 , -60 , 0 >,"rightSwitchLong2",index++))//10 后左 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateRandomArcNIUTitanEvent(qy,< 0 , -60 , 0 >,"leftSwitchLong02",index++))//8 前右 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 8, index++ ) )
	wave5.append(CreateRandomArcNIUTitanEvent(hz,< 0 , -60 , 0 >,"rightSwitchLong1",index++))//14 后右 一圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	...
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 10, index++ ) )
	wave5.append(CreateScorchTitanEvent(< -1680.21 ,3177.71, 118.764 >,< 0 , -60 , 0 >,"rightSwitchLong1",index++,1,"",FD_TitanType.TITAN_ELITE))//14 后右 一圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 10, index++ ) )
	wave5.append(CreateScorchTitanEvent(< 2430.32 ,3083.17, -79.5225 >,< 0 , -60 , 0 >,"rightSwitchLong2",index++,1,"",FD_TitanType.TITAN_ELITE))//10 后左 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 10, index++ ) )
	wave5.append(CreateScorchTitanEvent(< 2808.07 ,-3329.08, -58.9997 >,< 0 , -60 , 0 >,"leftSwitchLong01",index++,1,"",FD_TitanType.TITAN_ELITE))//9 前左转前座 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 10, index++ ) )
	wave5.append(CreateScorchTitanEvent(< -1764.65, -2245.26, 117 >,< 0 , -60 , 0 >,"leftSwitchLong02",index++,1,"",FD_TitanType.TITAN_ELITE))//8 前右 1圈
	wave5.append(CreateWaitForTimeEvent(0.6,index++))
	wave5.append(CreateWaitUntilAliveEvent( 10, index++ ) )
